  ...
  return (
    <>
      ...
      <div className="flex w-[393px] h-[852px] flex-col bg-[#0c0e09] overflow-clip">
        ...
        <div className="flex absolute w-[393px] h-fit flex-col z-[50] left-0 bottom-0 pt-3.5 pb-9 bg-white rounded-tl-[28px] rounded-tr-[28px] shadow-[0px_-8px_40px_rgba(0,0,0,0.25)] px-6 gap-5">
          <div className="flex w-10 h-1 flex-col mt-0 mb-1.5 bg-[#e5e5e0] rounded-full mx-0"></div>
          <div className="flex w-full justify-between items-center">
            <div className="text-[#0c0e09] font-['Inter'] text-xl font-bold leading-normal [display:inline-block] [overflow-wrap:normal]">Edit Pet Profile</div>
            <div className="size-8 flex justify-center items-center bg-[#f2f2ee] rounded-full">
          ...
          <div className="flex w-full flex-col items-center gap-2">
            <div className="size-[92px] flex relative flex-col">
              <div className="size-[92px] flex flex-col shrink-0 bg-[url('https://cdn.wonder.so/images/019f269b-6b46-777f-b695-785e0fb4f427/88085cb88b44c04228faa2fa5c052b8d735476b71c2f33c3d9aac2997e2dd7a9.jpg')] bg-cover bg-no-repeat rounded-full"></div>
              <div className="size-[30px] flex absolute justify-center items-center right-[-2px] bottom-[-2px] bg-[#fbff12] rounded-full border-[3px] border-white">
                <div className="size-3.5 flex flex-col text-[#0c0e09]">
            ...
            <div className="text-[#0c0e09] font-['Inter'] text-[13px] font-semibold leading-normal [display:inline-block] [overflow-wrap:normal]">Change photo</div>
          </div>
          <div className="flex w-full flex-col gap-3.5">
            ...
            <div className="flex w-full flex-col gap-1.5">
              <div className="text-[#6e6e6e] font-['Inter'] text-xs font-semibold leading-normal [display:inline-block] [overflow-wrap:normal]">Age</div>
              <div className="flex w-full h-[50px] items-center bg-[#f2f2ee] rounded-[14px] px-4 py-0">
                <div className="text-[#0c0e09] font-['Inter'] text-[15px] font-medium leading-normal [display:inline-block] [overflow-wrap:normal]">2 years old</div>
              </div>
            </div>
          </div>
          <div className="flex w-full items-center mt-1 mb-0 mx-0 gap-3">
            <div className="flex h-[52px] justify-center items-center bg-[#f2f2ee] flex-1 rounded-2xl">
              <div className="text-[#6e6e6e] font-['Inter'] text-[15px] font-semibold leading-normal [display:inline-block] [overflow-wrap:normal]">Cancel</div>
            </div>
            <div className="flex h-[52px] justify-center items-center bg-[#fbff12] flex-1 rounded-2xl">
              <div className="text-[#0c0e09] font-['Inter'] text-[15px] font-bold leading-normal [display:inline-block] [overflow-wrap:normal]">Save Changes</div>
            </div>
          </div>
        </div>
      </div>
