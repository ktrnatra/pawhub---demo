      ...
      <div className="flex w-[393px] h-[852px] flex-col bg-[#0c0e09] overflow-clip">
        ...
        <div className="flex absolute h-fit flex-col z-[10] left-3.5 right-3.5 bottom-5 bg-[#ffffffd9] border-t border-b border-l border-r shadow-[0px_16px_40px_rgba(12,14,9,0.28)] backdrop-blur-xl rounded-[28px] px-[22px] py-6 gap-[18px] border-[#ffffff99]">
          <div className="flex flex-col gap-[3px]">
            <div className="text-black font-['Inter'] text-base [display:inline-block] [overflow-wrap:normal]">Coco</div>
            <div className="text-black font-['Inter'] text-base [display:inline-block] [overflow-wrap:normal]">Pet ID: PHB-2024-00126</div>
          </div>
          <div className="flex flex-wrap gap-y-3.5">
            <div className="flex w-1/2 flex-col gap-0.5">
              ...
              <div className="text-black font-['Inter'] text-base [display:inline-block] [overflow-wrap:normal]">Dog</div>
            </div>
            <div className="flex w-1/2 flex-col gap-0.5">
              ...
              <div className="text-black font-['Inter'] text-base [display:inline-block] [overflow-wrap:normal]">Poodle</div>
            </div>
            <div className="flex w-1/2 flex-col gap-0.5">
              ...
              <div className="text-black font-['Inter'] text-base [display:inline-block] [overflow-wrap:normal]">2 years old</div>
            </div>
          </div>
